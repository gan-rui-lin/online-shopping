...
const menuItems = [
  { path: '/admin', label: 'Dashboard', icon: 'DataLine' },
  { path: '/admin/merchants', label: 'Merchant Audit', icon: 'OfficeBuilding' },
  { path: '/admin/products', label: 'Product Audit', icon: 'Goods' },
